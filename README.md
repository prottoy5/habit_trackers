...
The Firebase Authentication dashboard for HabitZen shows a list of registered users. It provides a clean and organized view of user data, including their email address, the date they were created and last signed in, and their unique user ID (UID). This demonstrates how the app securely manages user accounts and provides an administrative overview of the user base. 

<img width="1851" height="871" alt="Firebase_Authentication" src="https://github.com/user-attachments/assets/0ebd6ce9-466c-4de9-93bc-c40b1384e25c" />
